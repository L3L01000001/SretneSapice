...
namespace SretneSapice.Subscriber
{
    public class EmailService
    {
        ...
        public void SendEmail(string message)
        {
            try
            {
                ...
                string fromMail = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? "sretnesapice@outlook.com";
                string password = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "sapice123";
